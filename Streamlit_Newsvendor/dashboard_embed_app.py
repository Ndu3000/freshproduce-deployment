...
def main():
    ...
    if selection == "Trends":
        ...
        st.markdown("""
        <iframe width="1140" height="541.25" src="https://app.powerbi.com/reportEmbed?reportId=6ccca5da-cc0d-4642-8843-a361d4b90def&autoAuth=true&ctid=8adc40e0-da16-40b4-bd7c-bfd958719487&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLXNvdXRoLWFmcmljYS1ub3J0aC1hLXByaW1hcnktcmVkaXJlY3QuYW5hbHlzaXMud2luZG93cy5uZXQvIn0%3D" frameborder="0" allowFullScreen="true"></iframe>
        """, unsafe_allow_html=True)

        st.markdown("""
        <iframe width="1140" height="541.25" src="https://app.powerbi.com/reportEmbed?reportId=e0a96550-85f3-442d-ada7-2dbb5aeb330f&autoAuth=true&ctid=8adc40e0-da16-40b4-bd7c-bfd958719487&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLXNvdXRoLWFmcmljYS1ub3J0aC1hLXByaW1hcnktcmVkaXJlY3QuYW5hbHlzaXMud2luZG93cy5uZXQvIn0%3D" frameborder="0" allowFullScreen="true"></iframe>
        """, unsafe_allow_html=True)
